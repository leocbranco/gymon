                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            if ($row['FotoBin']) { ?>
                                ...
                                ?>
                                <td>
                                <a href='ExercicioAtualizar.php?id=<?php echo $cod; ?>'><img src='assets/Edit.png' title='Editar Disciplina' width='32'></a>
                                </td>
                                <td>
                                    <a href='ExercicioExcluir.php?id=<?php echo $cod; ?>'><img src='assets/Delete.png' title='Excluir Disciplina' width='32'></a>
                                </td>
                                </tr>
                    <?php
