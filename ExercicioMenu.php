...
---------------------------------------------------------------------------------->
	...
	<div class="w3-sidebar w3-bar-block w3-collapse w3-animate-left" style="z-index:3;width:270px" id="mySidebar">
		...
		<div id="menuDisc" class="myMenu" >
			...
			<a class="w3-bar-item w3-button" href='ExercicioListar.php'>Relação de Exercícios</a>
			<a class="w3-bar-item w3-button" href='ExercicioCriar.php'>Criar Novo Exercício</a>
